...
const CULTURA_DOSES = {
  cafe: {
    ...
    manutencao: [
      ...
      { insumo: 'Ekosil (silicato de K – 14% K₂O + Si)', dose: '150–280 kg/ha', obs: '1ª opção K: fortalece parede celular; reduz pressão de fungos; fonte de K + Si' },
  ...
  cacau: {
    ...
    manutencao: [
      ...
      { insumo: 'Ekosil (silicato de K – 14% K₂O + Si)', dose: '130–230 kg/ha', obs: '1ª opção K: fortalece casca do fruto; reduz vassoura-de-bruxa; fonte K + Si' },
  ...
  citros: {
    ...
    manutencao: [
      ...
      { insumo: 'Ekosil (silicato de K – 14% K₂O + Si)', dose: '150–280 kg/ha', obs: '1ª opção K: K + Si; reduz cancro cítrico e manchas fúngicas' },
  ...
  abacate: {
    ...
    manutencao: [
      ...
      { insumo: 'Ekosil (silicato de K – 14% K₂O + Si)', dose: '130–230 kg/ha', obs: '1ª opção K: K + Si; reduz Phytophthora e manchas em frutos' },
  ...
  pastagem_degradada: {
    ...
    manutencao: [
      ...
      { insumo: 'Ekosil (silicato de K – 14% K₂O + Si)', dose: '160–280 kg/ha', obs: '1ª opção K: K + Si; fortalece colmos e raízes; reduz acamamento' },
  ...
  milho: {
    ...
    manutencao: [
      ...
      { insumo: 'Ekosil (silicato de K – 14% K₂O + Si)', dose: '160–280 kg/ha', obs: '1ª opção K: K + Si; fortalece colmos e reduz acamamento; aplicar antes do plantio' },
  ...
  soja: {
    ...
    manutencao: [
      ...
      { insumo: 'Ekosil (silicato de K – 14% K₂O + Si)', dose: '200–350 kg/ha', obs: '1ª opção K: K é o 2º nutriente mais exigido pela soja após P; Si fortalece contra fungos e nematoides' },
...
const DOSES_K = {
  cafe:               { muito_baixo: '400–600 kg/ha', baixo: '280–400 kg/ha', medio: '150–280 kg/ha', bom: '60–120 kg/ha', alto: null },
  cacau:              { muito_baixo: '350–500 kg/ha', baixo: '230–350 kg/ha', medio: '130–230 kg/ha', bom: '50–100 kg/ha', alto: null },
  citros:             { muito_baixo: '400–600 kg/ha', baixo: '280–400 kg/ha', medio: '150–280 kg/ha', bom: '60–120 kg/ha', alto: null },
  manga:              { muito_baixo: '300–450 kg/ha', baixo: '200–300 kg/ha', medio: '120–200 kg/ha', bom: '50–100 kg/ha', alto: null },
  abacate:            { muito_baixo: '350–500 kg/ha', baixo: '230–350 kg/ha', medio: '130–230 kg/ha', bom: '50–100 kg/ha', alto: null },
  banana:             { muito_baixo: '500–700 kg/ha', baixo: '350–500 kg/ha', medio: '200–350 kg/ha', bom: '80–150 kg/ha', alto: null },
  pastagem_degradada: { muito_baixo: '350–500 kg/ha', baixo: '230–350 kg/ha', medio: '130–230 kg/ha', bom: '50–100 kg/ha', alto: null },
